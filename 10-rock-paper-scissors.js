...
document.querySelector('.your-moves').innerHTML = `Your Move: <img src="media/${playerMove}-choice.png" class="choice-icon" alt="">`;
document.querySelector('.cpu-moves').innerHTML = `CPU Move: <img src="media/${computerMove}-choice.png" class="choice-icon" alt="">`;
